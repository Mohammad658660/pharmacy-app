...
Route::middleware(['auth'])->group(function () {
    // مسار شاشة الأيقونات الرئيسية القديمة
Route::get('/home-menu', function () {
    return view('welcome');
})->name('home.menu');

    // الواجهة الرئيسية (اللوحة الرئيسية - Dashboard)
    ...
    // مسارات الفواتير
    Route::get('/sales/{id}/print', [InvoiceController::class, 'print'])->name('invoices.print');
    ...
    Route::get('/products/damaged', [ProductController::class, 'damaged'])->name('damaged.index');

    // تنفيذ الـ Migrations برمجياً
